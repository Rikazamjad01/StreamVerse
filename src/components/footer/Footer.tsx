...
const Footer = () => {
    return (
        <div className="w-full">
            {/* Hero CTA Section */}
            <section className="max-w-[1200px] w-full mx-auto flex flex-col md:flex-row items-center justify-between sm:px-5 md:px-6 lg:px-16 pt-6 bg-[var(--Primary)] rounded-2xl mb-[166px] gap-[100px]">
                <div className="flex-1 lg:w-[472px] md:w-[422px] sm:[372px] w-full max-sm:px-4">
                    ...
                    <p className="my-[10px] text-[var(--Background)] md:text-[18px] text-[16px]" style={{lineHeight: 'var(--P2-line-height)'}}>
                ...
                <div className="">
                    <Image
                        ...
                        width={560}
                        height={376}
                        className='xl:w-[560px] lg:w-[500px] md:w-[440px] sm:w-[400px] w-[360px]'
                    />
                </div>
            </section>
