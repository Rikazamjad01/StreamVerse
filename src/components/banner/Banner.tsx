...
const Banner = () => {
    return (
        <div className='sm:my-[100px] my-[50px] text-center max-w-[1200px] mx-auto flex flex-col items-center px-4'>
            ...
            <p style={{fontWeight: 'var(--S2-weight)', lineHeight: 'var(--P1-line-height)', fontSize: 'var(--P1-size)' }}>StreamVERSE is the ultimate livestreaming solution for content creators. Broadcast across multiple social media platforms like YouTube, TikTok, Instagram, Facebook, and BIGO—all at the same time.</p>
