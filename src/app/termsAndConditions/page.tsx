...
const data = [
  ...
  "• Unless stated otherwise, subscriptions automatically renew for the same term and price then in effect. You can cancel renewal in your account settings or through the app store provider before the renewal date.",
  "• Free trials, if offered, convert to paid plans unless you cancel before the trial ends.",
  "• Payments are processed by third-party processors or app stores; additional terms may apply.",
  "• Except where required by law, fees are non-refundable and non-transferable.",
  ...
  "User Content & License to StreamVerse",
  ...
  "Contact",
  "Questions about these Terms? Use the Contact page or email [your legal email here].",
  "Disclaimer",
