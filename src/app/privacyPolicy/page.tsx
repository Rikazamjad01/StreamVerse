...
const data = [
  ...
  "4) Payment data: StreamVerse uses in-app purchases (IAP) through Apple App Store and Google Play. All billing and payment information is processed by Apple or Google in accordance with their own privacy policies. We do not store full payment details (such as credit card numbers); we may retain limited purchase information (such as receipts, subscription status, and expiration dates) necessary for account access and customer support.",
